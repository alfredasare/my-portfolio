...
export const NodeJS = () => {
  return (
    <svg height="512px" style={{ enableBackground: "new 0 0 512 512" }} version="1.1" viewBox="0 0 512 512"
...
export const WS = () => {
  return (
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
         x="0px" y="0px"
         width="70px" height="70px" viewBox="0 0 70 70" style={{ enableBackground: "new 0 0 70 70" }}>
      <g>
        <g>
          <linearGradient id="SVGID_1_" gradientUnits="userSpaceOnUse" x1="25.0676" y1="1.4599" x2="43.1829"
                          y2="66.675">
            <stop offset="0.2849" style={{ stopColor: "#00CDD7" }}/>
            <stop offset="0.9409" style={{ stopColor: "#2086D7" }}/>
          </linearGradient>
          <polygon style={{ fill: "url(#SVGID_1_)" }}
                   points="9.4,63.3 0,7.3 17.5,0.1 28.6,6.7 38.8,1.2 60.1,9.4 48.1,70 		"/>
          <linearGradient id="SVGID_2_" gradientUnits="userSpaceOnUse" x1="30.7199" y1="9.7343" x2="61.365"
                          y2="54.6713">
            <stop offset="0.1398" style={{ stopColor: "#FFF045" }}/>
            <stop offset="0.3656" style={{ stopColor: "#00CDD7" }}/>
          </linearGradient>
          <polygon style={{ fill: "url(#SVGID_2_)" }}
                   points="70,23.7 61,1.4 44.6,0 19.3,24.3 26.1,55.6 38.8,64.6 70,46 62.3,31.7 		"/>
          <linearGradient id="SVGID_3_" gradientUnits="userSpaceOnUse" x1="61.0819" y1="15.2899" x2="65.1065"
                          y2="29.5436">
            <stop offset="0.2849" style={{ stopColor: "#00CDD7" }}/>
            <stop offset="0.9409" style={{ stopColor: "#2086D7" }}/>
          </linearGradient>
...
export const XD = () => {
  return (
    <svg id="ps_x5F_cc_x5F_app_x5F_RGB.svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 240 234" width="2500"
         height="2438">
...
export const Sagas = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="2500" height="1515" viewBox="0 0 66 40"
         preserveAspectRatio="xMinYMin meet">
      <path fill="#89D96D"
...
export const Moon = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25">
      <path fill="#000"
            d="M7.394 15c2.83.03 5.414-1.624 6.606-4.226-.75.331-1.562.494-2.38.476-3.208-.004-5.807-2.64-5.81-5.892.032-2.2 1.229-4.213 3.133-5.268C8.429.023 7.912-.006 7.394 0 3.31.001 0 3.36 0 7.501 0 11.641 3.31 15 7.394 15z"/>
    </svg>
  )
}
